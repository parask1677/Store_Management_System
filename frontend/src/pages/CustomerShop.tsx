                    ...
                    <div className="flex flex-col gap-3 mt-auto">
                      ...
                      <div className="grid grid-cols-2 gap-2">
                          <motion.button 
                            ...
                            className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors border flex items-center justify-center gap-1 ${
                              isOutOfStock || isMaxedOut
                              ? 'bg-dark-700 border-dark-600 text-gray-500 cursor-not-allowed'
                              : 'bg-dark-900 border-dark-600 text-white hover:border-emerald-500 hover:text-emerald-400'
                            }`}
                          >
                            <ShoppingCart size={16} />
                            {isMaxedOut && !isOutOfStock ? 'Max' : 'Add'}
                          </motion.button>
                          ...
                          <motion.button 
                            ...
                            disabled={isOutOfStock || isMaxedOut}
                            className={`px-3 py-2 rounded-lg text-sm font-bold transition-colors flex items-center justify-center gap-1 ${
                              isOutOfStock || isMaxedOut
